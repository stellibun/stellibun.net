...
fetch("https://status.cafe/users/stellibun/status.json")
  ...
  .then( r => {
    ...
    document.getElementById("statuscafe-username").innerHTML = "<div class=\"famfamfam-silk "+r.face+"\" style=\"top: 2px;position: relative;\"></div> / Stellibun <small>"+r.timeAgo+"</small>";
